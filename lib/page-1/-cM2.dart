            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 19.88*fem,
                  child: Image.asset(
                    'assets/page-1/images/icon-chevronleft-mWc.png',
                    width: 11.42*fem,
                    height: 19.88*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 19.88*fem,
                  child: Image.asset(
                    'assets/page-1/images/icon-chevronleft-8GU.png',
                    width: 11.42*fem,
                    height: 19.88*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Opacity(
                      // linearprogressindicatordark2eg (416:1902)
                      opacity: 0.52,
                      child: Container(
                        ...
                        child: Container(
                          // progressbarXrL (I416:1902;52818:24843)
                          width: 66*fem,
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        // leftsidehgG (I416:1882;839:7154)
                        ...
                        child: Container(
                          // statusbartimeRsA (I416:1882;839:7155)
                          width: double.infinity,
                          height: double.infinity,
                          decoration: BoxDecoration (
                      ...
                      Container(
                        // notch6yJ (I416:1882;1347:15626)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 13*fem, 16*fem),
                        width: 156*fem,
                        height: 33*fem,
                        child: Image.asset(
                          'assets/page-1/images/notch-joa.png',
                          width: 156*fem,
                          height: 33*fem,
                        ),
                      ),
                      Container(
                        // rightsideRVn (I416:1882;839:7156)
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // iconmobilesignalMPS (I416:1882;839:7165)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 8*fem, 0*fem),
                              width: 18*fem,
                              height: 12*fem,
                              child: Image.asset(
                                'assets/page-1/images/icon-mobile-signal-boS.png',
                                width: 18*fem,
                                height: 12*fem,
                              ),
                            ),
                            Container(
                              // wifiscg (I416:1882;839:7161)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 0.17*fem),
                              width: 17*fem,
                              height: 11.83*fem,
                              child: Image.asset(
                                'assets/page-1/images/wifi-dMe.png',
                                width: 17*fem,
                                height: 11.83*fem,
                              ),
                            ),
                            Container(
                              // statusbarbatteryPqv (I416:1882;1015:6374)
                              width: 27.4*fem,
                              height: 13*fem,
                              child: Image.asset(
                                'assets/page-1/images/statusbar-battery-RLG.png',
                                width: 27.4*fem,
                                height: 13*fem,
                              ),
                            ),
