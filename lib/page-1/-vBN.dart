              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      // adjustautolayoutspacingB64 (441:947)
                      left: 0.42578125*fem,
                      top: 0*fem,
                      child: Container(
                        width: 0.01*fem,
            ...
            Positioned(
              ...
              child: TextButton(
                ...
                child: Container(
                  ...
                  child: Center(
                    // arrowforward6MS (441:968)
                    child: SizedBox(
                      width: 32*fem,
                      height: 32*fem,
                      child: Image.asset(
                        'assets/page-1/images/arrowforward-iNp.png',
                        width: 32*fem,
                        height: 32*fem,
                      ),
                    ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration (
                  ...
                  image: DecorationImage (
                    fit: BoxFit.cover,
                    image: AssetImage (
                      'assets/page-1/images/rectangle-64-bg-kSY.png',
                    ),
                  ),
                ),
                child: Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration (
                  ...
                  image: DecorationImage (
                    fit: BoxFit.cover,
                    image: AssetImage (
                      'assets/page-1/images/rectangle-64-bg-Jj6.png',
                    ),
                  ),
                ),
                child: Text(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Container(
                              // statusbartimexkL (I441:973;839:7155)
                              width: double.infinity,
                              height: double.infinity,
                              decoration: BoxDecoration (
                          ...
                          Container(
                            // notchSfW (I441:973;1347:15626)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 13*fem, 16*fem),
                            width: 156*fem,
                            height: 33*fem,
                            child: Image.asset(
                              'assets/page-1/images/notch-kn8.png',
                              width: 156*fem,
                              height: 33*fem,
                            ),
                          ),
                          Container(
                            // rightsidekw6 (I441:973;839:7156)
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // iconmobilesignal5yN (I441:973;839:7165)
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 8*fem, 0*fem),
                                  width: 18*fem,
                                  height: 12*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/icon-mobile-signal-k4C.png',
                                    width: 18*fem,
                                    height: 12*fem,
                                  ),
                                ),
                                Container(
                                  // wifiD3z (I441:973;839:7161)
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 0.17*fem),
                                  width: 17*fem,
                                  height: 11.83*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/wifi-o6t.png',
                                    width: 17*fem,
                                    height: 11.83*fem,
                                  ),
                                ),
                                Container(
                                  // statusbarbatteryXaU (I441:973;1015:6374)
                                  width: 27.4*fem,
                                  height: 13*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/statusbar-battery-iVz.png',
                                    width: 27.4*fem,
                                    height: 13*fem,
                                  ),
                                ),
                    ...
                    Container(
                      // homeindicatorq5N (I441:972;5:3093)
