        ...
        child: Stack(
          children: [
              ...
              backgroundColors: [
                ...
                const Color(0x80BD00FF),
                const Color(0xFF000000),
                const Color(0x8059188C),
                const Color(0xFF000000),
                const Color(0xFFD9D9D9),
                const Color(0xFF000000),
                const Color(0xFFA26AAB),
              ],
            ),
            Positioned(
              // Syr (178:372)
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      decoration: InputDecoration (
                        ...
                        contentPadding: EdgeInsets.fromLTRB(21*fem, -6*fem, 21*fem, 7*fem),
            ...
            Positioned(
              ...
              child: TextButton(
                ...
                child: Container(
                  padding: EdgeInsets.fromLTRB(21*fem, 24*fem, 28*fem, 24*fem),
                  width: 127*fem,
                  height: 60*fem,
                  decoration: BoxDecoration (
                    color: Color(0xff000000),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(9*fem, 9*fem, 10*fem, 8*fem),
                        width: double.infinity,
                        decoration: BoxDecoration (
                          color: Color(0xff000000),
                          borderRadius: BorderRadius.circular(53*fem),
